...
4つの紹介ページ（rock-on-mj / ride-on-qc / reach-on-sanma / eat-on-gpx）で同じスクリプトを使い、
リポジトリのフォルダ名で配色と文言を切り替える。
"""
import os
...
SITES = {
    ...
    'eat-on-gpx': dict(
        name='Eat on GPX', assets='assets',
        head=['次のコンビニまで、', 'あと何km。'],
        tag='ルート沿いのコンビニ・食堂を、スタートからの距離順に。',
        url='pikaring.github.io/eat-on-gpx',
        paper=(249, 250, 247), ink=(24, 38, 32), muted=(132, 144, 138), accent=(30, 122, 76), glow=(220, 235, 224)),
    'reach-on-sanma': dict(
